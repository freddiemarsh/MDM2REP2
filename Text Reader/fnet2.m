function [fnetx,fnety] = fnet2(xp,yp,tx,ty,vx,vy,accelx,accely,desired_speed,a)
...
f = @(a,xforcewall,xforceprox,xforcenav) a(1) .* xforcewall + a(2) .* xforceprox +a(3) .* xforcenav - accelx;
fun = @(a)f(a,xforcewall,xforceprox,xforcenav)


% fnety = a(1) .* yforcewall + a(2) .* yforceprox +a(3) .* yforcenav-accely;
% 
% 
